...
theme.taglist_font                              = "Ubuntu Mono 14"
...
local blue   = "#80CCE6"
local space4 = markup.font("Monospace 4", " ")

-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space4 .. "%H:%M" .. space4))
mytextclock.font = theme.font
local clock_icon = wibox.widget.imagebox(theme.clock)
local clockbg = wibox.container.background(mytextclock, theme.box_color, gears.shape.rectangle)
local clockwidget = wibox.container.margin(clockbg, dpi(0), dpi(5), dpi(5), dpi(5))

-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space4 .. "%d %b " .. space4))
local calendar_icon = wibox.widget.imagebox(theme.calendar)
local calbg = wibox.container.background(mytextcalendar, theme.box_color, gears.shape.rectangle)
...
-- Separators
local first = wibox.widget.textbox('<span font="Ubuntu Mono 8"> </span>')
...
function theme.at_screen_connect(s)
    ...
    mytaglistcont = wibox.container.background(s.mytaglist, theme.box_color, gears.shape.rectangle)
